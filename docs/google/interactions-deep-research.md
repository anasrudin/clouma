...
API](/gemini-api/docs/interactions). You cannot access it through
`generate_content`.
...
Give the agent access to your own data by using the [File Search](/gemini-api/docs/interactions/file-search) tool.
...
You must set `stream=True` and `background=True`. For a comprehensive guide to streaming, including event types, tool streaming, and thinking, see [Streaming interactions](/gemini-api/docs/interactions/streaming).
...
- **Google search:** [Google
  Search](/gemini-api/docs/interactions/google-search) is enabled by
...
- Learn more about the [Interactions API](/gemini-api/docs/interactions).
- Learn how to use your own data using the [File Search](/gemini-api/docs/interactions/file-search)
  tool.
